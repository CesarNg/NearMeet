...
public class MessageViewHolder extends RecyclerView.ViewHolder {
    ...
    //ROOT VIEW
    @BindView(R.id.activity_friend_chat_item_root_view)
    ...
    @BindView(R.id.activity_friend_chat_item_message_container_text_message_container_text_view)
    TextView textViewMessage;
    //DATE TEXT
    @BindView(R.id.activity_friend_chat_item_message_container_text_view_date)
